export const AVOID_LIST = [
    ...
    .concat([
        ...
        "4xNpWxHgfwjAfmdSmdtFSapuk72ABnJzh6RCe7ZtwwfU", // dev Idl
        ...
        "Jd7ppnazZPxf77QXJ6PPG4tq1hYCGe1xFjUVi9ktgbz", // dev Idl
        "HGx1BfyXnzMV1TpEafKZW4gBRDVXo3TpRwzzfDzMeiTq", // dev Idl
    ])
    .concat([
        // OldPdas
        "8EaF2jHQ8ytow2S5oqQqbkuvP9NQTU4HYoBDzboE9xKA",
        "42CfNUzBRJfkkDAQTDGgndtT32g5DWnsTz3M7zseyGB7",
        "6iCwMy6LRRiVyCXCjweASxV4euWtLFxn4Puae5KQZfqu",
        "CUh9ms3jFCRP51hMU6JveYXsvmgd2mq96CKLBGxHusbN",
        "d7EYqhq6PSHg3pbp4isqDe4qFqqwTzzDEzZUcvuiZfT",
        "6j4nc1rS1dv2XTXhxS7EBa1aoD1HboP6bbxfKT1q1hTh",
        "DoWwsy5zyDyGRCZKCSWafcubELTMBu9vT7isjathhAaY",
        "6zgD31YAB5AjHciLAzAbJgZh5qhDN8kuDUkWKPZJMdgd",
        "6fTfjW7us94iG98iSU5nnC67ue972iZUFKSbP1HiSneH",
        "7xFxztXWuDbzLuouDBHCdfkvkktpYEJaDTBmJzecdmZx",
        "3jVWMkjWouNHEkrbA3P6Cbc4KVfXe7T8JoEo7G3fXCRm",
        "2ZmXLFKN4d3EHrPAY2DR4556JYM5qLPma3uHR92yAu9S",
        "4i8RPimBSS9KzRM5AqG9M3CEaSPrDaREm1Qmmb9mnxDG",
        "8ypjDYbbHK5t2JRxk8qgKpsAcsTXcDR3RPTMdxfLan3M",
        "2ThSwvWjQdACERhTbxdMFjnHNgEom1hV8TLESFEtm7Kr",
        "3bXXg8daPkCiwvx7vfQe43TLn8epzQG1PxWnHWiRXPMw",
        "33TggvigyyEKaroGBpd3BeqevvbXtPguT7dmLLVKaPiH",
        "HutFyhD2uAuaYxWRps2uE7hbay1MaNnfEyPNrsyS3exS",
        "kNKmBVCstvQ79Cator8EyNPRVToccA4E9mKTeLzVrBW",
        "6nXFtWreXWfEw4rkoXMH56CFWAQcZqWaz9a6yzCCRzCZ",
        "FBpHHDy8pHbmxSDFDSPMuJ8EYSTKg8VBc8wF2uTPh5ie",
        "6FGaS9dnHNaGo4aYtv91NQXJ3P1mX9Rgsdi6GkLKasuw",
        "AD2rQ2nvz3obscmrbJZVkiWSBXHRUy2mqT1vXujXXKH1",
        "J7X3ahuUMxJTFjBGQ8GC3TdUHGSjMQK8vdeJAgCkvkuV",
        "Aa4WWh4ri3G1A4mVUhuvSPnX2uYj5FmundSywE7Fo4Dh",
        "26FSiWxVmsjJ9WMbxi9RkGwCDVMdSy9udBg4Yvtz21PA",
        "9FTYmFXwMCehSEdsrPhTkqsd6jT4KcSSvrWBY5tah37N",
        "9P9SpLzzvMZvLTGthjzemqQ2WzqzhPgg6UGi7yFo4cTs",
        "55NpMwiVpB7pprf6jQkjDs2RTqiQiivJr8X2BpMNoafo",
        "6aTiwMThTxJfDeqmY9GiQPpPk728QS6U6Xkdqitm2u5c",
        "5a38DACWSNfaesnWFaJLoaAouQAiBFet8gFH786jwAon",
    ])
    .concat([
        //main idl
